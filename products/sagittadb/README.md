# SagittaDB Enterprise v1.0.5-dev.10.5899724

这是 SagittaDB Enterprise 客户部署包。部署包只包含生产部署配置，应用代码通过固定版本 Docker 镜像交付。

## 镜像

- 后端：`ghcr.io/lynn-lee/sagittadb-backend:1.0.5-dev.10.5899724`
- 前端：`ghcr.io/lynn-lee/sagittadb-frontend:1.0.5-dev.10.5899724`
...
```bash
./upgrade.sh 1.0.5-dev.10.5899724
```
...
```bash
docker load < sagittadb-backend-1.0.5-dev.10.5899724.tar
docker load < sagittadb-frontend-1.0.5-dev.10.5899724.tar
docker compose up -d
```
