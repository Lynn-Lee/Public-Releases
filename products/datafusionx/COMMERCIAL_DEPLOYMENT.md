...
公开仓库不应作为客户专属镜像的唯一保护边界；正式客户交付建议使用私有 GHCR package、客户 token、限期下载链接或离线镜像包，并记录压缩包 sha256、release manifest 签名、后端镜像 digest、前端镜像 digest、客户编码、交付批次和 License 授权号。
