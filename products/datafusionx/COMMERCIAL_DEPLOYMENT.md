...
- Public-Releases 是 DataFusionX Enterprise 的公开下载和推广主通道，公开包默认使用 `DATAFUSIONX_COMMERCIAL_CUSTOMER_ID=public-release` 作为水印。
...
- workflow 会阻止源码、私钥、真实 License、激活码、客户部署指纹、授权中心 token、sourcemap、浮动镜像标签或源码构建配置误发到 Public-Releases。
