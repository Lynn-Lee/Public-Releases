...
- 版本：`0.1.0-dev.23.4c1cc08`
- 公开发布水印：`public-release`
- 交付批次：`0.1.0-dev.23.4c1cc08`
- 分发模式：`public-release`
- 后端镜像：`ghcr.io/lynn-lee/datafusionx-backend:0.1.0-dev.23.4c1cc08`
- 前端镜像：`ghcr.io/lynn-lee/datafusionx-frontend:0.1.0-dev.23.4c1cc08`
