# StreamForge 商业版 v0.1.0-dev.18.8532624
...
- 后端：`ghcr.io/lynn-lee/streamforge/backend-commercial:0.1.0-dev.18.8532624`
- 控制台：`ghcr.io/lynn-lee/streamforge/console-commercial:0.1.0-dev.18.8532624`
...
helm upgrade --install streamforge ./helm \
  --set image.backend='ghcr.io/lynn-lee/streamforge/backend-commercial:0.1.0-dev.18.8532624' \
  --set image.console='ghcr.io/lynn-lee/streamforge/console-commercial:0.1.0-dev.18.8532624' \
...
```bash
./upgrade.sh 0.1.0-dev.18.8532624
```
